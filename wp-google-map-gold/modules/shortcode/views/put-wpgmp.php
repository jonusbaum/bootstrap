...
$map_locations = array_slice($map_locations,0,$how_many-1);
}
...
$marker_image = "<img src='".$location->location_settings['featured_image']."' class='wpgmp_marker_image' />";
} else {
$marker_image = '';
}
...
$feature_image_size = apply_filters('wpgmp_featured_image_size','thumbnail',$post,$map);
...
$val['slug'] = str_replace('%','',$val['slug']);
if($val['slug']=="category"){$val['slug']= 'post_categories';}
$listing_custom_filters['list'][$val['slug']] = $val['text'];
}
...
$listing_div .= '<div class="location_listing'.$map->map_id.' '.apply_filters('wpgmp_listing_class','',$map).'" style="float:left; width:100%;"></div><div class="location_pagination'.$map->map_id.' '.apply_filters('wpgmp_pagination_class','',$map).' wpgmp_pagination" style="float:left; width:100%;"></div>';
}
