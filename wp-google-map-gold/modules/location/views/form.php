...
$form->add_element( 'text', 'location_title', array(
	'label' => __( 'Location Title', WPGMP_TEXT_DOMAIN ),
...
$form->add_element( 'text', 'location_address', array(
	'label' => __( 'Location Address', WPGMP_TEXT_DOMAIN ),
...
$form->add_element( 'text', 'location_latitude', array(
	'label' => __( 'Latitude and Longitude', WPGMP_TEXT_DOMAIN ),
...
$form->add_element( 'text', 'location_city', array(
	'label' => __( 'City and State', WPGMP_TEXT_DOMAIN ),
...
$form->add_element( 'text', 'location_country', array(
	'label' => __( 'Country and Postal Code', WPGMP_TEXT_DOMAIN ),
...
$form->add_element( 'div', 'wpgmp_map', array(
	'label' => __( 'Current Location', WPGMP_TEXT_DOMAIN ),
	'id' => 'wpgmp_map',
...
$form->add_element( 'radio', 'location_settings[onclick]', array(
	'label' => __( 'On Click', WPGMP_TEXT_DOMAIN ),
...
$form->add_element( 'text', 'location_settings[redirect_link]', array(
	'label' => __( 'Redirect Url',WPGMP_TEXT_DOMAIN ),
...
$form->add_element('image_picker', 'location_settings[featured_image]', array(
	'label' => __( 'Location Image', WPGMP_TEXT_DOMAIN ),
	'src' => wp_unslash( $data['location_settings']['featured_image'] ) ,
	'required' => false,
...
$form->add_element( 'select', 'location_settings[redirect_link_window]', array(
	...
	'label' => __( 'Open new tab',WPGMP_TEXT_DOMAIN ),
...
$form->add_element( 'checkbox', 'location_settings[hide_infowindow]', array(
	'label' => __( 'Disable Infowindow', WPGMP_TEXT_DOMAIN ),
	'value' => 'false',
...
$form->add_element( 'checkbox', 'location_infowindow_default_open', array(
	'label' => __( 'Infowindow Default Open', WPGMP_TEXT_DOMAIN ),
	'value' => 'true',
...
$form->add_element( 'checkbox', 'location_draggable', array(
	'label' => __( 'Marker Draggable', WPGMP_TEXT_DOMAIN ),
	'value' => 'true',
...
$form->add_element( 'select', 'location_animation', array(
	'label' => __( 'Marker Animation', WPGMP_TEXT_DOMAIN ),
